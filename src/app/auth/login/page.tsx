...
export default function LoginPage() {
  ...
  const { loginWithEmail, loginWithGoogle, isAuthenticated, initializeAuth } = useChatStore();
    ...
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      >
        <div className="max-w-lg text-center">
          ...
          >
            <motion.h1 
              className="text-6xl xl:text-7xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-4"
              animate={{
            ...
            <div className="flex justify-center space-x-2 mb-8">
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 animate-pulse delay-100" />
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-pink-400 to-orange-400 animate-pulse delay-200" />
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-4xl xl:text-5xl font-bold text-white leading-tight">
              Connect with
              <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"> Friends</span>
            </h2>
            ...
            <div className="grid grid-cols-1 gap-4 mt-12">
              ...
              <motion.div
                ...
                className="backdrop-blur-sm bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center space-x-4"
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-pink-500 to-orange-500 flex items-center justify-center">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <div className="w-full max-w-md space-y-8">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full flex items-center justify-center px-6 py-4 backdrop-blur-sm bg-white/20 border border-white/30 rounded-2xl text-sm font-medium text-white hover:bg-white/30 focus:outline-none focus:ring-4 focus:ring-blue-500/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed group"
          >
            <motion.div
            ...
            >
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-4 pl-12 backdrop-blur-sm bg-white/10 border border-white/30 rounded-2xl text-white placeholder-blue-200 focus:border-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-500/30 transition-all duration-300"
          ...
          >
            <div className="text-sm text-blue-200">
              ...
              <Link 
                href="/auth/register" 
                className="font-semibold text-pink-300 hover:text-pink-200 transition-colors relative inline-block"
              >
                <span className="relative z-10">Sign up</span>
                <motion.div
                  className="absolute inset-0 bg-pink-500/20 rounded-lg -z-10"
